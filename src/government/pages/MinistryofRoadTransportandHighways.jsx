...
import { ministryofroadtransportandhighwayscomplaints, ministryofroadtransportandhighwayscategories } from "../data/complaints";
import { FaPhone, FaMicrophone, FaPaperclip, FaTimes, FaPaperPlane } from "react-icons/fa";
import { motion } from "framer-motion";

const MinistryofRoadTransportandHighways = () => {
    const { gov_id } = useParams();
    const allcomplaints = ministryofroadtransportandhighwayscomplaints;
    const allcategories = ministryofroadtransportandhighwayscategories;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 p-6 md:p-12 flex flex-col items-center">
            {/* Header */}
            <div className="text-center flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-gray-600 max-md:text-sm text-lg mt-2 font-semibold">
                    Responsible for maintaining road infrastructure, traffic management, and transport safety to ensure smooth and secure travel for all citizens.
                </p>
            ...
            <div className="mt-8 w-full max-w-md">
                ...
                <select
                    className="w-full p-3 rounded-lg border border-gray-300 focus:ring focus:ring-orange-300 transition"
                ...
                >
                    <div className="bg-white w-[90%] md:w-[600px] h-[500px] rounded-lg shadow-xl flex flex-col">
                        ...
                        <div className="flex-1 p-4 overflow-y-auto">
                            ...
                            <div className="bg-orange-100 p-4 rounded-lg shadow text-right">
...
export default MinistryofRoadTransportandHighways;
